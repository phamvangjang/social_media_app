    ...
    return (
        <div className='flex flex-col h-[420px] overflow-y-scroll no-scrollbar'>
            <div className="flex items-center mb-4 mt-2">
                <img crossOrigin='anonymous' src="https://instagram.fsgn4-1.fna.fbcdn.net/v/t51.2885-19/118982623_353024589077161_7490638455124782637_n.jpg?stp=dst-jpg_tt6&_nc_ht=instagram.fsgn4-1.fna.fbcdn.net&_nc_cat=101&_nc_ohc=ejpoFY0pDsAQ7kNvgHoajPq&_nc_gid=60ae2c75195147dfabaf16d95bc0bc66&edm=AP4sbd4BAAAA&ccb=7-5&oh=00_AYCKcYOfOVyE-GkUBkEYfjJCBtpALC4lKNKMmr0s3YY51A&oe=6749CAE8&_nc_sid=7a9f4b" alt="Profile picture" className="w-10 h-10 rounded-full mr-3" />
                <div>
                    <div>
